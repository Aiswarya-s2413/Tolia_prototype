"""
Django settings for steel_sahayak_backend project.
"""
...
SECRET_KEY = 'django-insecure-steel-sahayak-ai-prototype-secret-key-123456'
...
ROOT_URLCONF = 'tolia_backend.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'steel_sahayak_db'),
        'USER': os.getenv('DB_USER', 'aiswarya'),
