...
def get_general_assistant_response(query_text, target_lang='en', user_role=Department.QC):
    ...
    if target_lang == 'hi':
        return (
            ...
            "• 🏭 **फैक्ट्री SOPs:** ब्लास्ट फर्नेस, रोलिंग मिल और क्वालिटी कंट्रोल की मानक संचालन प्रक्रियाओं की जानकारी देना।\n"
            "• ⚠️ **सुरक्षा एवं आपातकालीन प्रोटोकॉल:** आपातकालीन शटडाउन (Valve B-4, नाइट्रोजन पर्ज) और अनिवार्य PPE नियमों का मार्गदर्शन करना।\n"
            "• 🔒 **भूमिका-आधारित सुरक्षा (RBAC):** गोपनीय बिक्री व राजस्व डेटा केवल CEO तक सीमित रखना और QC कर्मियों को तकनीकी SOPs प्रदान करना।\n"
            "• 🎙️ **बहुभाषी वॉयस एवं चैट:** हिंदी, मराठी और अंग्रेजी में रीयल-टाइम वॉइस व चैट सहायता देना।"
        )
    elif target_lang == 'mr':
        return (
            ...
            "• 🏭 **फॅक्टरी SOPs:** ब्लास्ट फर्नेस, रोलिंग मिल आणि स्टील गुणवत्ता चाचणीच्या अधिकृत प्रक्रिया स्पष्ट करणे.\n"
            "• ⚠️ **सुरक्षा व आपत्कालीन नियम:** आपत्कालीन शटडाउन आणि अनिवार्य PPE किट नियमांचे अचूक मार्गदर्शन करणे.\n"
            "• 🔒 **सुरक्षित प्रवेश (RBAC):** गोपनीय विक्री डेटा फक्त CEO साठी सुरक्षित ठेवणे आणि QC निरीक्षकांना तांत्रिक SOPs पुरवणे.\n"
            "• 🎙️ **बहुभाषिक संवाद:** मराठी, हिंदी आणि इंग्रजीमध्ये रिअल-टाइम व्हॉइस व टेक्स्ट सपोर्ट देणे."
        )
    else:
        return (
            "🤖 **I am Tolia AI** — a voice-enabled industrial Factory Assistant for steel plant operations.\n\n"
            "🎯 **My Core Purpose & Functionalities:**\n"
            "• 🏭 **Factory SOPs & Maintenance:** Step-by-step procedures for Blast Furnace operations, Rolling Mill maintenance, and Quality Control.\n"
            "• ⚠️ **Safety & Emergency Protocols:** Instant instructions for emergency shutdowns (Valve B-4, Nitrogen purge) and mandatory PPE compliance.\n"
            "• 🔒 **Role-Based Access Control (RBAC):** Restricting confidential commercial & sales data strictly to authorized CEO personnel while providing technical SOPs to QC inspectors.\n"
